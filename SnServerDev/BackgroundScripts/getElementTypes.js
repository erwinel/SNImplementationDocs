...
var tableName = 'sc_category';
function indentLines(l) { return l.map(function (value) { return (value.trim().length === 0) ? "" : "\t" + value; }); }
var typeMap = {
...
if (sys_db_object.next()) {
    ...
    while (gr.next()) {
        if (!gr.element.nil()) {
            ...
            if (element.length > 0) {
                var internal_type = gr.internal_type.toString();
                var jsType = "GlideElement";
                var description = "";
