        ...
        if (typeof (value) === 'object') {
            ...
            if (ColorInfo.isColorModelRgb(value)) {
                ...
                if (ColorInfo.isColorModelRgb2(value, false))
                    ...
                    rgb = {
                        r: (<IColorModelRgb2>value).red / 100.0, g: (<IColorModelRgb2>value).green / 100.0, b: (<IColorModelRgb2>value).blue / 100.0,
        ...
        if (typeof (value) === 'object') {
            if (ColorInfo.isColorModelRgb(value)) {
                ...
                if (ColorInfo.isPercentageValue((<IColorModelRgb>value).a))
                    return {
                        r: ColorInfo.percentageToByte((<IColorModelRgb>value).r), g: ColorInfo.percentageToByte((<IColorModelRgb>value).g),
            ...
            if (ColorInfo.isColorModelRgb2(value)) {
                ...
                if (ColorInfo.isPercentageValue((<IColorModelRgb2>value).alpha))
                    return {
                        r: ColorInfo.percentageToByte((<IColorModelRgb2>value).red), g: ColorInfo.percentageToByte((<IColorModelRgb2>value).green),
