...
function advancedScriptFunction(current: IArmyUserGlideRecord, answer: boolean): void {
...
function executeRule(current: IincidentGlideRecord, previous: IincidentGlideRecord | null /*null when async*/) {
