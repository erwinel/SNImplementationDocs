namespace sys {
    ...
    /**
     * Ensures the {@link URL#pathname} ends with a "/".
     *
     * @export
     * @param {URL} url - The source {@link URL}.
     * @returns {URL} - A {@link URL} that ends with a "/".
     */
    export function makeDirectoryUrl(url: URL): URL;
    /**
     * Ensures the path portion of the URL string ends with a "/".
     *
     * @export
     * @param {string} url - The source URL string.
     * @returns {string} - The URL string with the path portion ending with a "/".
     */
    export function makeDirectoryUrl(url: string): string;
