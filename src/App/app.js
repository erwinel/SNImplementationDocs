        ...
        */
        constructor(persistentStorageLoader, $http, $log, $root, $q) {
            ...
            if (sys.notNil(original)) {
                ...
                original = {};
            let promise = $http.get("./appConfigData.json").then((result) => {
...
(function (app) {
    ...
    app.appModule.directive(app.DIRECTIVE_NAME_configUrl, [appConfigLoaderService.SERVICE_NAME, (appConfigLoader) => {
            return {
                restrict: "AE",
                link: (scope, element, attrs) => {
                    function updateText() {
