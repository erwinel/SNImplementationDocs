...
declare interface ICustomClass<N extends string> {
    type: N;
    initialize(this: ICustomClass<N>): void;
}

interface ICustomClassConstructor<T extends ICustomClass<string>> {
    new(): T;
    prototype: T;
}

declare abstract class Class {
    static create<T extends ICustomClassConstructor<any>>(): T;
}