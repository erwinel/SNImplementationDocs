...
namespace fieldEdit {
  ...
  export interface IFieldInputParentScope<TParent extends app.IMainControllerScope> extends app.INestedControllerScope<TParent> {
    inputFieldValueChanged(name: string, value: any | undefined): void;
    getInputFieldValue(name: string): any | undefined;
  }
  export interface IFieldInputScope<TParent extends app.IMainControllerScope> extends IFieldInputParentScope<TParent>, app.INestedControllerScope<TParent> {
    name: string;
    label: string;
    text: string;
    value: any;
  ...
  export abstract class fieldEditController<TParentScope extends app.IMainControllerScope, TScope extends IFieldInputScope<TParentScope>> extends app.MainControllerChild<TScope> {
    ...
    constructor($scope: TScope, name: string, label?: string, isRequired: boolean = false) {
      super($scope);
    ...
    private onValidationChange(): void {
      let cssClassNames = app.asArray<string>(this.$scope.cssClassNames);
      let i: number;
    ...
    protected convertToString(value: any | null | undefined): string { return app.asNotNil(value, ''); }
  ...
  export interface IUrlFieldInputScope<TParent extends app.IMainControllerScope> extends IFieldInputScope<TParent> { url?: URL; }
  export abstract class urlFieldEditController<TParentScope extends app.IMainControllerScope, TScope extends IUrlFieldInputScope<TParentScope>> extends fieldEditController<TParentScope, TScope> {
    constructor($scope: TScope, name: string, label?: string) { super($scope, name); }
    protected updateValidationMessage() {
...
namespace app {
  ...
  */
  ...
  // #region SetupParameterDefinitionScope
  ...
  function initializeSetupParameterDefinitionScope(parentScope: IMainControllerScope, controller: MainController) {
    let scope: ISetupParameterDefinitionScope = parentScope.setupParameterDefinitions = <ISetupParameterDefinitionScope>(parentScope.$new());
    ...
    scope.inputFieldValueChanged = (name: string, value: any | undefined) => { controller.setupParameterValueChanged(name, value); };
    scope.getInputFieldValue = (name: string, ) => { return controller.getSetupParameterValue(name); };
  }

  enum SetupParameterFieldNames {
    serviceNowUrl = 'serviceNowUrl',
    gitRepositoryBaseUrl = 'gitRepositoryBaseUrl'
  }

  class serviceNowUrlFieldEditController extends fieldEdit.urlFieldEditController<ISetupParameterDefinitionScope, fieldEdit.IUrlFieldInputScope<ISetupParameterDefinitionScope>> {
    constructor($scope: fieldEdit.IUrlFieldInputScope<ISetupParameterDefinitionScope>) { super($scope, SetupParameterFieldNames.serviceNowUrl, 'ServiceNow URL'); }
  }
  MainModule.controller("serviceNowUrlFieldEditController", ['$scope', serviceNowUrlFieldEditController]);

  class gitRepositoryBaseUrlFieldEditController extends fieldEdit.urlFieldEditController<ISetupParameterDefinitionScope, fieldEdit.IUrlFieldInputScope<ISetupParameterDefinitionScope>> {
    constructor($scope: fieldEdit.IUrlFieldInputScope<ISetupParameterDefinitionScope>) { super($scope, SetupParameterFieldNames.gitRepositoryBaseUrl, 'Git Repository Base URL'); }
  }
  ...
  function initializeDialogScope(parentScope: IMainControllerScope, controller: MainController) {
    let scope: IDialogScope = parentScope.popupDialog = <IDialogScope>(parentScope.$new());
    scope.isVisible = false;
    scope.title = '';
    scope.message = '';
    scope.bodyClass = '';
    scope.show = (message: string, type: DialogMessageType = 'info', title?: string) => { controller.showDialog(message, type, title); };
  ...
  class MainController implements ng.IController {
    ...
    setupParameterValueChanged(name: string, value: any | undefined) {
      switch (name) {
        case SetupParameterFieldNames.serviceNowUrl:
          this.$scope.setupParameterDefinitions.serviceNowUrl = <string>value;
          break;
        case SetupParameterFieldNames.gitRepositoryBaseUrl:
          this.$scope.setupParameterDefinitions.gitRepositoryBaseUrl = <string>value;
          break;
      }
    }
    ...
    constructor(protected $scope: IMainControllerScope, protected $location: ng.ILocationService, protected $http: ng.IHttpService) {
  ...
  MainModule.controller("MainController", ['$scope', "$location", "$http", , MainController]);
  ...
  export abstract class MainControllerChild<TScope extends INestedControllerScope<IMainControllerScope>> implements ng.IController {
    ...
    showDialog(message: string, type: DialogMessageType = 'info', title?: string) { this.$scope.popupDialog.show(message, type, title); };
    closeDialog() { this.$scope.popupDialog.isVisible = false; }
    setupParameterValueChanged(name: string, value: any | undefined) { this.$scope.setupParameterDefinitions.inputFieldValueChanged(name, value); };
    getSetupParameterValue(name: string): any | undefined { return this.$scope.setupParameterDefinitions.getInputFieldValue(name); };
  }
