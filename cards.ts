...
namespace cards {
    ...
    export interface ICardContainerScope extends ng.IScope {
        // TODO: Test Changes - selectedCardName?: string;
        ...
        // TODO: Test Changes - indexOfCard(name: string): number;
        indexOfCard(scopeId: number): number;
        // TODO: Test Changes - nameOfCard(index: number): string;
    ...
    export abstract class CardController extends CardParentController {
         ...
         */
        constructor(protected $scope: ICardScope, headingText: string) {
            super($scope);
